...
const CreatePost = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font-extrabold text-[#222384] text-[32px]'>
          Create
        </h1>
        <p className='mt-2 text-[#666e75] text-[14px] max-w-[600px]'>Create imaginative and visually stunning images through DALL-E AI and share them with the community</p>
      </div>
